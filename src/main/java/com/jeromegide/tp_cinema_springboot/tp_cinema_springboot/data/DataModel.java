package com.jeromegide.tp_cinema_springboot.tp_cinema_springboot.data;

import com.jeromegide.tp_cinema_springboot.tp_cinema_springboot.model.Film;
import com.jeromegide.tp_cinema_springboot.tp_cinema_springboot.model.Personne;
...
public class DataModel{
    ...
    public DataModel(List<Personne> personnes, List<Film> films) {
        this.personnes = personnes;
        this.films = films;
    }
    ...
    public DataModel() {
        ...
        films.add(new Film("La guerre des étoiles", 4.4, "f0002.jpg", "Il y a bien longtemps, dans une galaxie très lointaine... La guerre civile fait rage entre " +
        ...
        films.add(new Film("Pretty woman", 3.5, "f0003.jpg",  "Edward Lewis, homme d'affaires performant, rencontre par hasard Vivian Ward, beaute fatale " +
                "qui arpente chaque nuit les trottoirs d'Hollywood Boulevard. La jeune femme ne fera qu'une " +
                "bouchee du brillant PDG.",
                personnes.get(20)));

        films.add(new Film("BEN-HUR", 4.0, "f0006.jpg",  "Judas Ben-Hur, " +
        ...
        films.add(new Film("E.T. l'extra-terrestre", 4.2, "f0004.jpg",  "Une soucoupe volante atterrit en pleine nuit près de Los Angeles. Quelques extraterrestres, " +
        ...
        films.add(new Film("Légendes d'automne", 3.9, "f0004.jpg",  "Au cœur des contrées sauvages du Montana, trois frères, Alfred, Tristan et Samuel sont " +
